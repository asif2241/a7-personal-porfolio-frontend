...
const MySkills = () => {
    return (
        <div className='flex flex-col lg:flex-row gap-4 max-w-[1140px] w-full  mx-auto py-8 px-4  bg-base-300 justify-center items-center my-5'>
            {/* text */}
            <div className='lg:flex-1 px-4'>
                <h3 className='font-bold text-2xl '>Available for New Oppotunities!</h3>
